...
namespace starrocks {
class Ip360EnglishLocationService : public BaseLocationService {
public:
...
private:
    constexpr static std::array<LanguageEnum, 1> supported_languages = {LanguageEnum::EN};

    constexpr static std::string_view path = "/data/home/ta/ip_data_ta/aw_en.ipdb";
};
}
